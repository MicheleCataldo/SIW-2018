...
//	- Aggiungere l'entita' CORSO(codice, nome), molti a molti con Studente.
	...
	public static void main(String args[]) {
		...
		//data di nascita
		cal.set(1994, Calendar.MARCH, 14); // // 14 marzo 1994
		...
		//data di iscrizione
		cal.set(2010, Calendar.OCTOBER, 10); // 10 ottobre 2010
		Date date11 = cal.getTime();
		cal.set(2008, Calendar.AUGUST, 11); // 11 agosto 2008
		Date date12 = cal.getTime();
		cal.set(2011, Calendar.JULY, 4);  // 4 luglio 2011
		...
		Studente studente1 = new Studente("00000001","Rossi","Mario",date1,date11);
		...
		studente2.setDataIscrizione(date12);
		...
		studente3.setDataIscrizione(date13);
